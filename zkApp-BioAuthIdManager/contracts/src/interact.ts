/**
 * This script can be used to interact with the BioAuthIdManager contract, after deploying it.
 *
...
let zkApp = new BioAuthIdManager(zkAppAddress);

// compile the contract to create prover keys
console.log('compile the contract...');
await BioAuthIdManager.compile();
